...
PHP_MINIT_FUNCTION(reflection) /* {{{ */
{
	...
	INIT_CLASS_ENTRY(_reflection_entry, "ReflectionEnum", class_ReflectionEnum_methods);
	reflection_init_class_handlers(&_reflection_entry);
	_reflection_entry.ce_flags |= ZEND_ACC_FINAL;
	reflection_enum_ptr = zend_register_internal_class_ex(&_reflection_entry, reflection_class_ptr);

	INIT_CLASS_ENTRY(_reflection_entry, "ReflectionEnumUnitCase", class_ReflectionEnumUnitCase_methods);
	reflection_init_class_handlers(&_reflection_entry);
	_reflection_entry.ce_flags |= ZEND_ACC_FINAL;
