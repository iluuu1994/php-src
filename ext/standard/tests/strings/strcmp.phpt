...
- strcmp of 'string' and '1' is => 
Deprecated: Implicit bool to string coercion is deprecated in %s on line %d
int(66)
- strcmp of 'string' and '' is => 
Deprecated: Implicit bool to string coercion is deprecated in %s on line %d
int(6)
