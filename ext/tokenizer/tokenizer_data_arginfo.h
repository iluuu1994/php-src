...
static void register_tokenizer_data_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("T_PRIVATE_SET", T_PRIVATE_SET, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_PROTECTED_SET", T_PROTECTED_SET, CONST_CS | CONST_PERSISTENT);
