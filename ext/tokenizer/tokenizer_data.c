...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_PARENT_ACCESSOR_NAME", T_PARENT_ACCESSOR_NAME, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_PARENT_ACCESSOR_NAME: return "T_PARENT_ACCESSOR_NAME";
