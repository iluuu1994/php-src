...
PHPAPI ZEND_PURE zval *cfg_get_entry(const char *name, size_t name_length);
...
PHPAPI ZEND_PURE int php_ini_has_per_dir_config(void);
PHPAPI ZEND_PURE int php_ini_has_per_host_config(void);
...
PHPAPI ZEND_CONST HashTable* php_ini_get_configuration_hash(void);
END_EXTERN_C()
