...
__asm__(
    ...
    ".ascii \"gdb.execute('''\\n\"\n"
    ".ascii \"set $Z_PTR_SHIFT = 16\\n\"\n"
    ".ascii \"set $Z_TYPE_INFO_MASK = 0x3f\\n\"\n"
    ".ascii \"set $Z_TYPE_MASK = 0x0f\\n\"\n"
    ".ascii \"set $Z_TYPE_SHIFT = 6\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"define set_ts\\n\"\n"
    ...
    ".ascii \"	set $type = ($zvalue->u32.a & $Z_TYPE_MASK)\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"	# 15 == IS_INDIRECT\\n\"\n"
    ".ascii \"	if $type > 5 && $type < 12\\n\"\n"
    ".ascii \"		printf \\\"(refcount=%d) \\\", ((zend_refcounted*)($zvalue->ptr >> $Z_PTR_SHIFT))->gc.refcount\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"	if $type == 0\\n\"\n"
    ".ascii \"		printf \\\"UNDEF\\\"\\n\"\n"
    ...
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 4\\n\"\n"
    ".ascii \"		printf \\\"long: %ld\\\", ((int64_t)$zvalue->u64 - ((int64_t)$zvalue->u64 & $Z_TYPE_INFO_MASK)) / (1 << $Z_TYPE_SHIFT)\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 5\\n\"\n"
    ".ascii \"		printf \\\"double: %f\\\", (double)*(float*)&$zvalue->u32.b\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 6\\n\"\n"
    ".ascii \"		printf \\\"string: %s\\\", (char*)((zend_string*)($zvalue->ptr >> $Z_PTR_SHIFT))->val\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 7\\n\"\n"
    ".ascii \"		printf \\\"array: \\\"\\n\"\n"
    ".ascii \"		if ! $arg1\\n\"\n"
    ".ascii \"			set $ind = $ind + 1\\n\"\n"
    ".ascii \"			____print_ht ((HashTable*)($zvalue->ptr >> $Z_PTR_SHIFT)) 1\\n\"\n"
    ".ascii \"			set $ind = $ind - 1\\n\"\n"
    ".ascii \"			set $i = $ind\\n\"\n"
    ".ascii \"			while $i > 0\\n\"\n"
    ".ascii \"				printf \\\"  \\\"\\n\"\n"
    ...
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 9\\n\"\n"
    ".ascii \"		printf \\\"resource: #%d\\\", ((zend_resource*)($zvalue->ptr >> $Z_PTR_SHIFT))->handle\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 10\\n\"\n"
    ".ascii \"		printf \\\"reference: \\\"\\n\"\n"
    ".ascii \"		____printzv &((zend_reference*)($zvalue->ptr >> $Z_PTR_SHIFT))->val $arg1\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 11\\n\"\n"
    ...
    ".ascii \"		____printzv ((zval*)($zvalue->ptr >> $Z_PTR_SHIFT)) $arg1\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 13\\n\"\n"
    ".ascii \"		printf \\\"pointer: %p\\\", ((void*)($zvalue->ptr >> $Z_PTR_SHIFT))\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 15\\n\"\n"
    ".ascii \"		printf \\\"_ERROR\\\"\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ...
    ".ascii \"		end\\n\"\n"
    ".ascii \"		set $n = $ind\\n\"\n"
    ".ascii \"		set $type = ($val->u32.a & $Z_TYPE_MASK)\\n\"\n"
    ".ascii \"		if $type > 0\\n\"\n"
    ".ascii \"			while $n > 0\\n\"\n"
    ".ascii \"				printf \\\"  \\\"\\n\"\n"
    ".ascii \"				set $n = $n - 1\\n\"\n"
    ...
    ".ascii \"			end\\n\"\n"
    ".ascii \"			if $arg1 == 3\\n\"\n"
    ".ascii \"				set $func = ((zend_function*)($zvalue->ptr >> $Z_PTR_SHIFT))\\n\"\n"
    ".ascii \"				printf \\\"\\\\\\\\\\\"%s\\\\\\\\\\\"\\\\\\\\n\\\", (char*)$func->common.function_name->val\\n\"\n"
    ".ascii \"			end\\n\"\n"
    ".ascii \"			if $arg1 == 4\\n\"\n"
    ".ascii \"				set $const = ((zend_constant*)($zvalue->ptr >> $Z_PTR_SHIFT))\\n\"\n"
