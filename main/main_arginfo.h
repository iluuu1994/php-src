 ...
 * Stub hash: 46f9ff0e23e68945667887894274f65483ebe1d4 */
...
static void register_main_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("PHP_INT_MAX", 144115188075855871, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("PHP_INT_MIN", -144115188075855872, CONST_PERSISTENT);
