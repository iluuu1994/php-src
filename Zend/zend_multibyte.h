...
ZEND_API ZEND_PURE const zend_multibyte_functions *zend_multibyte_get_functions(void);
...
ZEND_API ZEND_PURE const zend_encoding *zend_multibyte_get_script_encoding(void);
