...
ZEND_API ZEND_PURE zend_class_entry *zend_get_exception_base(zend_object *object);

/* Deprecated - Use zend_ce_exception directly instead */
ZEND_API ZEND_PURE zend_class_entry *zend_exception_get_default(void);

/* Deprecated - Use zend_ce_error_exception directly instead */
ZEND_API ZEND_PURE zend_class_entry *zend_get_error_exception(void);
...
ZEND_API ZEND_PURE bool zend_is_unwind_exit(const zend_object *ex);
ZEND_API ZEND_PURE bool zend_is_graceful_exit(const zend_object *ex);
