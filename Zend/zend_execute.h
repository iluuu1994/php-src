...
ZEND_API ZEND_PURE const char *get_active_function_name(void);
ZEND_API ZEND_PURE const char *get_active_function_arg_name(uint32_t arg_num);
...
ZEND_API ZEND_PURE const char *zend_get_executed_filename(void);
