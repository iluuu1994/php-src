...
ZEND_VM_HELPER(zend_add_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_C_LABEL(add_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_add_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_sub_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_C_LABEL(sub_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_sub_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_mul_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_C_LABEL(mul_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_mul_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}
...
ZEND_VM_HELPER(zend_mod_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_COLD_CONSTCONST_HANDLER(5, ZEND_MOD, CONST|TMPVARCV, CONST|TMPVARCV)
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_mod_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_shift_left_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_COLD_CONSTCONST_HANDLER(6, ZEND_SL, CONST|TMPVARCV, CONST|TMPVARCV)
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_shift_left_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_shift_right_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_COLD_CONSTCONST_HANDLER(7, ZEND_SR, CONST|TMPVARCV, CONST|TMPVARCV)
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_shift_right_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}
...
ZEND_VM_HELPER(zend_is_equal_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	int ret;
	USE_OPLINE
...
ZEND_VM_C_LABEL(is_equal_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_is_equal_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_is_not_equal_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	int ret;
	USE_OPLINE
...
ZEND_VM_C_LABEL(is_not_equal_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_is_not_equal_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_is_smaller_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	int ret;
	USE_OPLINE
...
ZEND_VM_C_LABEL(is_smaller_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_is_smaller_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_is_smaller_or_equal_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	int ret;
	USE_OPLINE
...
ZEND_VM_C_LABEL(is_smaller_or_equal_double):
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_is_smaller_or_equal_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}
...
ZEND_VM_HELPER(zend_bw_or_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(9, ZEND_BW_OR, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(COMMUTATIVE))
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_bw_or_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_bw_and_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(10, ZEND_BW_AND, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(COMMUTATIVE))
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_bw_and_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}

ZEND_VM_HELPER(zend_bw_xor_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(11, ZEND_BW_XOR, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(COMMUTATIVE))
{
	...
	uint8_t op1_type = RT_OP1_TYPE;
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_bw_xor_helper, op_1, op1, op_2, op2, op1_type, op1_type, op2_type, op2_type);
}
...
ZEND_VM_HELPER(zend_bw_not_helper, ANY, ANY, zval *op_1, uint8_t op1_type)
{
	USE_OPLINE
...
ZEND_VM_HOT_NOCONST_HANDLER(13, ZEND_BW_NOT, CONST|TMPVARCV, UNUSED)
{
	USE_OPLINE
	zval *op1;
	...
	uint8_t op1_type = RT_OP1_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_bw_not_helper, op_1, op1, op1_type, op1_type);
}

ZEND_VM_COLD_CONST_HANDLER(14, ZEND_BOOL_NOT, CONST|TMPVAR|CV, UNUSED)
{
	USE_OPLINE
	zval *val;
...
ZEND_VM_HANDLER(29, ZEND_ASSIGN_STATIC_PROP_OP, ANY, ANY, OP)
{
	...
	prop = zend_fetch_static_property_address(&prop_info, (opline+1)->extended_value, BP_VAR_RW, 0, OP1_TYPE, OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
	if (UNEXPECTED(!prop)) {
		UNDEF_RESULT();
		FREE_OP_DATA();
		HANDLE_EXCEPTION();
...
ZEND_VM_C_LABEL(assign_dim_op_new_array):
		...
		value = get_op_data_zval_ptr_r(RT_OP_DATA_TYPE, (opline+1)->op1);
...
ZEND_VM_HANDLER(38, ZEND_PRE_INC_STATIC_PROP, ANY, ANY, CACHE_SLOT)
{
	...
	prop = zend_fetch_static_property_address(&prop_info, opline->extended_value, BP_VAR_RW, 0, OP1_TYPE, OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
	if (UNEXPECTED(!prop)) {
		UNDEF_RESULT();
		HANDLE_EXCEPTION();
	}
...
ZEND_VM_HELPER(zend_pre_inc_helper, VAR|CV, UNUSED)
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(34, ZEND_PRE_INC, VAR|CV, UNUSED, SPEC(RETVAL))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(35, ZEND_PRE_DEC, VAR|CV, UNUSED, SPEC(RETVAL))
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(36, ZEND_POST_INC, VAR|CV, UNUSED)
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HELPER(zend_post_dec_helper, VAR|CV, UNUSED)
{
	USE_OPLINE
	zval *var_ptr;
...
ZEND_VM_HOT_HANDLER(37, ZEND_POST_DEC, VAR|CV, UNUSED)
{
	USE_OPLINE
	zval *var_ptr;
...
/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CONST|VAR) */
ZEND_VM_INLINE_HELPER(zend_fetch_static_prop_helper, ANY, ANY, int type, uint8_t op1_type, uint8_t op2_type)
{
	USE_OPLINE
	zval *prop;
	zend_property_info *prop_info;
	...
	prop = zend_fetch_static_property_address(
		...
		type == BP_VAR_W ? opline->extended_value : 0, op1_type, op2_type OPLINE_CC EXECUTE_DATA_CC);
	if (UNEXPECTED(!prop)) {
...
ZEND_VM_HANDLER(173, ZEND_FETCH_STATIC_PROP_R, ANY, ANY, CACHE_SLOT)
{
	uint8_t op1_type = OP1_TYPE;
	uint8_t op2_type = OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_static_prop_helper, type, BP_VAR_R, op1_type, op1_type, op2_type, op2_type);
}

/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(174, ZEND_FETCH_STATIC_PROP_W, ANY, ANY, FETCH_REF|DIM_WRITE|CACHE_SLOT)
{
	uint8_t op1_type = OP1_TYPE;
	uint8_t op2_type = OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_static_prop_helper, type, BP_VAR_W, op1_type, op1_type, op2_type, op2_type);
}

/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(175, ZEND_FETCH_STATIC_PROP_RW, ANY, ANY, CACHE_SLOT)
{
	uint8_t op1_type = OP1_TYPE;
	uint8_t op2_type = OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_static_prop_helper, type, BP_VAR_RW, op1_type, op1_type, op2_type, op2_type);
}

/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(177, ZEND_FETCH_STATIC_PROP_FUNC_ARG, ANY, ANY, FETCH_REF|CACHE_SLOT)
{
...
/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(178, ZEND_FETCH_STATIC_PROP_UNSET, ANY, ANY, CACHE_SLOT)
{
	uint8_t op1_type = OP1_TYPE;
	uint8_t op2_type = OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_static_prop_helper, type, BP_VAR_UNSET, op1_type, op1_type, op2_type, op2_type);
}

/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(176, ZEND_FETCH_STATIC_PROP_IS, ANY, ANY, CACHE_SLOT)
{
	uint8_t op1_type = OP1_TYPE;
	uint8_t op2_type = OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_fetch_static_prop_helper, type, BP_VAR_IS, op1_type, op1_type, op2_type, op2_type);
}
...
ZEND_VM_C_LABEL(fetch_obj_r_fast_copy):
					...
					if (ZEND_IS_PROPERTY_HOOK_SIMPLE_READ(prop_offset)) {
						...
						opline = hook->op_array.slim_opcodes;
#else
						EX(opline) = hook->op_array.slim_opcodes;
#endif
						LOAD_OPLINE_EX();
...
ZEND_VM_C_LABEL(free_and_exit_assign_obj):
	if (UNEXPECTED(RETURN_VALUE_USED(EX_WOP2)) && value) {
		ZVAL_COPY_DEREF(EX_VAR(opline->result.var), value);
	}
	FREE_OP_DATA();
...
ZEND_VM_HANDLER(25, ZEND_ASSIGN_STATIC_PROP, ANY, ANY, CACHE_SLOT, SPEC(OP_DATA=CONST|TMP|VAR|CV))
{
	...
	prop = zend_fetch_static_property_address(&prop_info, opline->extended_value, BP_VAR_W, 0, OP1_TYPE, OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
	if (UNEXPECTED(!prop)) {
		FREE_OP_DATA();
		UNDEF_RESULT();
		HANDLE_EXCEPTION();
...
ZEND_VM_HANDLER(22, ZEND_ASSIGN, VAR|CV, CONST|TMP|VAR|CV, SPEC(RETVAL))
{
	...
	if (!ZEND_VM_SPEC || UNEXPECTED(RETURN_VALUE_USED(EX_WOP2))) {
		zend_refcounted *garbage = NULL;
...
ZEND_VM_HANDLER(33, ZEND_ASSIGN_STATIC_PROP_REF, ANY, ANY, CACHE_SLOT|SRC)
{
	...
	prop = zend_fetch_static_property_address(&prop_info, opline->extended_value & ~ZEND_RETURNS_FUNCTION, BP_VAR_W, 0, OP1_TYPE, OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
	if (UNEXPECTED(!prop)) {
		FREE_OP_DATA();
		UNDEF_RESULT();
		HANDLE_EXCEPTION();
...
ZEND_VM_HOT_HANDLER(42, ZEND_JMP, UNUSED|JMP_ADDR, UNUSED)
{
	USE_OPLINE
...
ZEND_VM_HOT_NOCONST_HANDLER(43, ZEND_JMPZ, CONST|TMPVAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *val;
	uint8_t op1_type;
...
ZEND_VM_HOT_NOCONST_HANDLER(44, ZEND_JMPNZ, CONST|TMPVAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *val;
	uint8_t op1_type;
...
ZEND_VM_COLD_CONST_HANDLER(46, ZEND_JMPZ_EX, CONST|TMPVAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *val;
	bool ret;
...
ZEND_VM_COLD_CONST_HANDLER(47, ZEND_JMPNZ_EX, CONST|TMPVAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *val;
	bool ret;
...
ZEND_VM_HOT_HANDLER(59, ZEND_INIT_FCALL_BY_NAME, UNUSED, CONST, NUM|CACHE_SLOT)
{
	USE_OPLINE
	zend_function *fbc;
...
ZEND_VM_HANDLER(128, ZEND_INIT_DYNAMIC_CALL, UNUSED, CONST|TMPVAR|CV, NUM)
{
	USE_OPLINE
	zval *function_name;
	zend_execute_data *call;
...
ZEND_VM_HOT_HANDLER(69, ZEND_INIT_NS_FCALL_BY_NAME, UNUSED, CONST, NUM|CACHE_SLOT)
{
	USE_OPLINE
	zval *func_name;
	zval *func;
...
ZEND_VM_HOT_HANDLER(61, ZEND_INIT_FCALL, UNUSED|NUM, CONST, NUM|CACHE_SLOT)
{
	USE_OPLINE
	zval *fname;
	zval *func;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_INIT_FCALL, Z_EXTRA_P(RT_CONSTANT(op, op->op2)) != 0, ZEND_INIT_FCALL_OFFSET, UNUSED|NUM, CONST, NUM|CACHE_SLOT)
{
	USE_OPLINE
	zend_function *fbc;
	zend_execute_data *call;
...
ZEND_VM_HOT_HANDLER(129, ZEND_DO_ICALL, UNUSED, UNUSED, SPEC(RETVAL,OBSERVER))
{
	USE_OPLINE
	...
	ret = RETURN_VALUE_USED(EX_WOP2) ? EX_VAR(opline->result.var) : &retval;
	ZVAL_NULL(ret);
...
ZEND_VM_HOT_HANDLER(130, ZEND_DO_UCALL, UNUSED, UNUSED, SPEC(RETVAL,OBSERVER))
{
	USE_OPLINE
	zend_execute_data *call = EX(call);
	zend_function *fbc = call->func;
...
ZEND_VM_HOT_HANDLER(131, ZEND_DO_FCALL_BY_NAME, UNUSED, UNUSED, SPEC(RETVAL,OBSERVER))
{
	USE_OPLINE
	zend_execute_data *call = EX(call);
	zend_function *fbc = call->func;
	...
	const uint32_t no_discard = RETURN_VALUE_USED(EX_WOP2) ? 0 : ZEND_ACC_NODISCARD;
...
ZEND_VM_HOT_HANDLER(60, ZEND_DO_FCALL, UNUSED, UNUSED, SPEC(RETVAL,OBSERVER))
{
	USE_OPLINE
	zend_execute_data *call = EX(call);
	zend_function *fbc = call->func;
...
ZEND_VM_COLD_CONST_HANDLER(111, ZEND_RETURN_BY_REF, CONST|TMP|VAR|CV, UNUSED, SRC, SPEC(OBSERVER))
{
	USE_OPLINE
	zval *retval_ptr;
	zval *return_value;
...
ZEND_VM_HOT_HANDLER(63, ZEND_RECV, UNUSED|NUM, UNUSED)
{
	USE_OPLINE
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_RECV, op->op2.num == MAY_BE_ANY, ZEND_RECV_NOTYPE, UNUSED|NUM, UNUSED|NUM)
{
	USE_OPLINE
	uint32_t arg_num = opline->op1.num;
...
ZEND_VM_HOT_HANDLER(64, ZEND_RECV_INIT, UNUSED|NUM, CONST)
{
	USE_OPLINE
	uint32_t arg_num;
	zval *param;
...
ZEND_VM_HANDLER(164, ZEND_RECV_VARIADIC, UNUSED|NUM, UNUSED)
{
	USE_OPLINE
	uint32_t arg_num = opline->op1.num;
...
ZEND_VM_HELPER(zend_case_helper, ANY, ANY, zval *op_1, zval *op_2, uint8_t op2_type)
{
	int ret;
	USE_OPLINE
...
ZEND_VM_C_LABEL(case_double):
	...
	uint8_t op2_type = RT_OP2_TYPE;
	ZEND_VM_DISPATCH_TO_HELPER(zend_case_helper, op_1, op1, op_2, op2, op2_type, op2_type);
}
...
ZEND_VM_HANDLER(68, ZEND_NEW, UNUSED|CLASS_FETCH|CONST|VAR, UNUSED|CACHE_SLOT, NUM)
{
	...
	if (constructor == NULL) {
		...
		if (EXPECTED(opline->extended_value == 0 && Z_WOP_FROM_OP(opline+1)->opcode == ZEND_DO_FCALL)) {
			ZEND_VM_NEXT_OPCODE_EX(1, 2);
		}
...
ZEND_VM_HOT_HANDLER(99, ZEND_FETCH_CONSTANT, UNUSED|CONST_FETCH, CONST, CACHE_SLOT)
{
	...
	SAVE_OPLINE();
	zend_quick_get_constant(RT_CONSTANT(opline, opline->op2) + 1, opline->op1.num, opline->extended_value OPLINE_CC EXECUTE_DATA_CC);
	ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
}
...
ZEND_VM_COLD_CONST_HANDLER(51, ZEND_CAST, CONST|TMP|VAR|CV, UNUSED, TYPE)
{
	USE_OPLINE
	zval *expr;
...
ZEND_VM_HANDLER(73, ZEND_INCLUDE_OR_EVAL, CONST|TMPVAR|CV, UNUSED, EVAL, SPEC(OBSERVER))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(77, ZEND_FE_RESET_R, CONST|TMP|VAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
...
ZEND_VM_COLD_CONST_HANDLER(125, ZEND_FE_RESET_RW, CONST|TMP|VAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
...
ZEND_VM_HELPER(zend_fe_fetch_object_helper, VAR, ANY)
{
	// FIXME: We can use sop op hints since the helper has the same signature as the handler.
	USE_OPLINE
	zval *array;
	zval *value;
	uint32_t value_type;
...
/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(180, ZEND_ISSET_ISEMPTY_STATIC_PROP, ANY, ANY, ISSET|CACHE_SLOT)
{
	USE_OPLINE
	zval *value;
	bool result;
	...
	value = zend_fetch_static_property_address(NULL, opline->extended_value & ~ZEND_ISEMPTY, BP_VAR_IS, 0, OP1_TYPE, OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
...
ZEND_VM_HANDLER(57, ZEND_BEGIN_SILENCE, UNUSED, UNUSED)
{
	USE_OPLINE
...
ZEND_VM_COLD_CONST_HANDLER(152, ZEND_JMP_SET, CONST|TMP|VAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *value;
	zend_reference *ref = NULL;
...
ZEND_VM_COLD_CONST_HANDLER(169, ZEND_COALESCE, CONST|TMP|VAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *value;
	zend_reference *ref = NULL;
...
ZEND_VM_HOT_NOCONST_HANDLER(198, ZEND_JMP_NULL, CONST|TMP|VAR|CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	zval *val, *result;
...
ZEND_VM_HANDLER(146, ZEND_DECLARE_ANON_CLASS, CONST, ANY, CACHE_SLOT)
{
	zval *zv;
	zend_class_entry *ce;
	USE_OPLINE
...
ZEND_VM_HANDLER(105, ZEND_TICKS, UNUSED, UNUSED, NUM)
{
	USE_OPLINE
...
ZEND_VM_HOT_HANDLER(0, ZEND_NOP, UNUSED, UNUSED)
{
	USE_OPLINE
...
ZEND_VM_HELPER(zend_dispatch_try_catch_finally_helper, ANY, ANY, uint16_t try_catch_offset, uint16_t op_num)
{
	...
	for (; try_catch_offset != (uint16_t) -1; try_catch_offset--) {
		...
		if (op_num < try_catch->catch_op && ex) {
			...
			ZEND_VM_JMP_EX(&EX(func)->op_array.slim_opcodes[try_catch->catch_op], 0);
			...
			ZEND_VM_JMP_EX(&EX(func)->op_array.slim_opcodes[try_catch->finally_op], 0);
...
{
	const zend_slim_op *throw_sop = EG(opline_before_exception);

	/* Exception was thrown before executing any op */
	if (UNEXPECTED(!throw_sop)) {
		ZEND_VM_DISPATCH_TO_HELPER(zend_dispatch_try_catch_finally_helper, try_catch_offset, -1, op_num, 0);
	}

	const zend_op *throw_op = Z_WOP_FROM_OP(throw_sop);
	uint32_t throw_op_num = throw_sop - EX(func)->op_array.slim_opcodes;
...
ZEND_VM_HANDLER(150, ZEND_USER_OPCODE, ANY, ANY)
{
	...
	SAVE_OPLINE();
	ret = zend_user_opcode_handlers[wop->opcode](execute_data);
	...
	switch (ret) {
		...
		case ZEND_USER_OPCODE_DISPATCH:
			ZEND_VM_DISPATCH(wop->opcode, opline);
		default:
...
ZEND_VM_HANDLER(162, ZEND_FAST_CALL, UNUSED|JMP_ADDR, ANY)
{
	USE_OPLINE
	...
	Z_OBJ_P(fast_call) = NULL;
	/* set return address */
	Z_OPLINE_NUM_P(fast_call) = opline - EX(func)->op_array.slim_opcodes;
	ZEND_VM_JMP_EX(OP_JMP_ADDR(opline, opline->op1), 0);
}
...
ZEND_VM_HANDLER(163, ZEND_FAST_RET, ANY, TRY_CATCH)
{
	...
	current_op_num = opline - EX(func)->op_array.slim_opcodes;
...
ZEND_VM_HOT_NOCONST_HANDLER(123, ZEND_TYPE_CHECK, CONST|TMPVAR|CV, UNUSED, TYPE_MASK)
{
	USE_OPLINE
	zval *value;
	int result = 0;
...
ZEND_VM_HOT_HANDLER(122, ZEND_DEFINED, CONST, UNUSED, CACHE_SLOT)
{
	USE_OPLINE
	zend_constant *c;
...
ZEND_VM_C_LABEL(defined_false):
	...
	if (zend_quick_check_constant(RT_CONSTANT(opline, opline->op1), opline->extended_value OPLINE_CC EXECUTE_DATA_CC) != SUCCESS) {
...
ZEND_VM_HANDLER(151, ZEND_ASSERT_CHECK, UNUSED, UNUSED|JMP_ADDR)
{
	USE_OPLINE
...
ZEND_VM_HANDLER(203, ZEND_BIND_INIT_STATIC_OR_JMP, CV, UNUSED|JMP_ADDR)
{
	USE_OPLINE
	HashTable *ht;
	zval *value;
...
ZEND_VM_HANDLER(208, ZEND_JMP_FRAMELESS, CONST, UNUSED|JMP_ADDR, NUM|CACHE_SLOT)
{
	USE_OPLINE
...
ZEND_VM_HANDLER(204, ZEND_FRAMELESS_ICALL_0, UNUSED, UNUSED, NUM, SPEC(OBSERVER))
{
	USE_OPLINE
	SAVE_OPLINE();
...
#endif
	{
		zend_frameless_function_0 function = (zend_frameless_function_0)ZEND_FLF_HANDLER(opline->extended_value);
		function(EX_VAR(opline->result.var));
	}
	ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
}

ZEND_VM_HANDLER(205, ZEND_FRAMELESS_ICALL_1, ANY, UNUSED, NUM, SPEC(OBSERVER))
{
	USE_OPLINE
	SAVE_OPLINE();
...
#endif
	{
		zend_frameless_function_1 function = (zend_frameless_function_1)ZEND_FLF_HANDLER(opline->extended_value);
...
ZEND_VM_HANDLER(206, ZEND_FRAMELESS_ICALL_2, ANY, ANY, NUM, SPEC(OBSERVER))
{
	USE_OPLINE
	SAVE_OPLINE();
...
#endif
	{
		zend_frameless_function_2 function = (zend_frameless_function_2)ZEND_FLF_HANDLER(opline->extended_value);
...
ZEND_VM_HANDLER(207, ZEND_FRAMELESS_ICALL_3, ANY, ANY, NUM, SPEC(OBSERVER))
{
	USE_OPLINE
	SAVE_OPLINE();
...
#endif
	{
		zend_frameless_function_3 function = (zend_frameless_function_3)ZEND_FLF_HANDLER(opline->extended_value);
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_JMP, (OP_JMP_ADDR(op, op->op1) > op), ZEND_JMP_FORWARD, UNUSED|JMP_ADDR, UNUSED)
{
	USE_OPLINE
...
ZEND_VM_HELPER(zend_interrupt_helper, ANY, ANY)
{
	...
	if (zend_atomic_bool_load_ex(&EG(timed_out))) {
		...
		if (EG(exception)) {
			...
			const zend_op *throw_op = Z_WOP_FROM_OP(EG(opline_before_exception));
