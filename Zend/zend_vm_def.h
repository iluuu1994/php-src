...
ZEND_VM_HANDLER(97, ZEND_FETCH_OBJ_UNSET, TMPVAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT)
{
	USE_OPLINE
...
ZEND_VM_HANDLER(76, ZEND_UNSET_OBJ, TMPVAR|UNUSED|THIS|CV, CONST|TMPVAR|CV, CACHE_SLOT)
{
	USE_OPLINE
	zval *container;
	zval *offset;
