...
$op1_type = array(
    "ANY"      => "EX_OPLINE_EX2(execute_data, opline)->op1_type",
    "TMP"      => "IS_TMP_VAR",
    "VAR"      => "IS_VAR",
    "CONST"    => "IS_CONST",
    "UNUSED"   => "IS_UNUSED",
...
$op2_type = array(
    "ANY"      => "EX_OPLINE_EX2(execute_data, opline)->op2_type",
    "TMP"      => "IS_TMP_VAR",
    "VAR"      => "IS_VAR",
    "CONST"    => "IS_CONST",
    "UNUSED"   => "IS_UNUSED",
...
$op1_get_zval_ptr = array(
    "ANY"      => "get_zval_ptr(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
...
$op2_get_zval_ptr = array(
    "ANY"      => "get_zval_ptr(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
...
$op1_get_zval_ptr_ptr = array(
    "ANY"      => "get_zval_ptr_ptr(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
...
$op2_get_zval_ptr_ptr = array(
    "ANY"      => "get_zval_ptr_ptr(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
...
$op1_get_zval_ptr_deref = array(
    "ANY"      => "get_zval_ptr_deref(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op1.var EXECUTE_DATA_CC)",
    ...
    "TMPVAR"   => "???",
    "TMPVARCV" => "_get_zval_ptr_tmpvarcv(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1 EXECUTE_DATA_CC)",
);

$op2_get_zval_ptr_deref = array(
    "ANY"      => "get_zval_ptr_deref(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op2.var EXECUTE_DATA_CC)",
    ...
    "TMPVAR"   => "???",
    "TMPVARCV" => "_get_zval_ptr_tmpvarcv(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1 EXECUTE_DATA_CC)",
);

$op1_get_zval_ptr_undef = array(
    "ANY"      => "get_zval_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op1.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op1)",
    "UNUSED"   => "NULL",
...
$op2_get_zval_ptr_undef = array(
    "ANY"      => "get_zval_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op2.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op2.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op2)",
    "UNUSED"   => "NULL",
...
$op1_get_zval_ptr_ptr_undef = array(
    "ANY"      => "get_zval_ptr_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
    "VAR"      => "_get_zval_ptr_ptr_var(opline->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "zend_get_bad_ptr()",
    "UNUSED"   => "NULL",
...
$op2_get_zval_ptr_ptr_undef = array(
    "ANY"      => "get_zval_ptr_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
    "VAR"      => "_get_zval_ptr_ptr_var(opline->op2.var EXECUTE_DATA_CC)",
    "CONST"    => "zend_get_bad_ptr()",
    "UNUSED"   => "NULL",
...
$op1_get_obj_zval_ptr = array(
    "ANY"      => "get_obj_zval_ptr(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op1.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op1)",
    "UNUSED"   => "&EX(This)",
...
$op2_get_obj_zval_ptr = array(
    "ANY"      => "get_obj_zval_ptr(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op2.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op2.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op2)",
    "UNUSED"   => "&EX(This)",
...
$op1_get_obj_zval_ptr_undef = array(
    "ANY"      => "get_obj_zval_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op1.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op1)",
    "UNUSED"   => "&EX(This)",
...
$op2_get_obj_zval_ptr_undef = array(
    "ANY"      => "get_obj_zval_ptr_undef(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "_get_zval_ptr_tmp(opline->op2.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var(opline->op2.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT(opline, opline->op2)",
    "UNUSED"   => "&EX(This)",
...
$op1_get_obj_zval_ptr_ptr = array(
    "ANY"      => "get_obj_zval_ptr_ptr(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
    "VAR"      => "_get_zval_ptr_ptr_var(opline->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "zend_get_bad_ptr()",
    "UNUSED"   => "&EX(This)",
...
$op2_get_obj_zval_ptr_ptr = array(
    "ANY"      => "get_obj_zval_ptr_ptr(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
    "VAR"      => "_get_zval_ptr_ptr_var(opline->op2.var EXECUTE_DATA_CC)",
    "CONST"    => "zend_get_bad_ptr()",
    "UNUSED"   => "&EX(This)",
...
$op1_free_op = array(
    "ANY"      => "FREE_OP(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1.var)",
    ...
    "TMPVARCV" => "FREE_OP(EX_OPLINE_EX2(execute_data, opline)->op1_type, opline->op1.var)",
);

$op2_free_op = array(
    "ANY"      => "FREE_OP(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2.var)",
    ...
    "TMPVARCV" => "FREE_OP(EX_OPLINE_EX2(execute_data, opline)->op2_type, opline->op2.var)",
);

$op1_free_op_if_var = array(
    "ANY"      => "if (EX_OPLINE_EX2(execute_data, opline)->op1_type == IS_VAR) {zval_ptr_dtor_nogc(EX_VAR(opline->op1.var));}",
    "TMP"      => "",
    "VAR"      => "zval_ptr_dtor_nogc(EX_VAR(opline->op1.var))",
    "CONST"    => "",
    "UNUSED"   => "",
...
$op2_free_op_if_var = array(
    "ANY"      => "if (EX_OPLINE_EX2(execute_data, opline)->op2_type == IS_VAR) {zval_ptr_dtor_nogc(EX_VAR(opline->op2.var));}",
    "TMP"      => "",
    "VAR"      => "zval_ptr_dtor_nogc(EX_VAR(opline->op2.var))",
    "CONST"    => "",
    "UNUSED"   => "",
...
$op_data_type = array(
    "ANY"      => "EX_OPLINE_EX2(execute_data, opline+1)->op1_type",
    "TMP"      => "IS_TMP_VAR",
    "VAR"      => "IS_VAR",
    "CONST"    => "IS_CONST",
    "UNUSED"   => "IS_UNUSED",
...
$op_data_get_zval_ptr = array(
    "ANY"      => "get_op_data_zval_ptr_r(EX_OPLINE_EX2(execute_data, opline+1)->op1_type, (opline+1)->op1)",
...
$op_data_get_zval_ptr_undef = array(
    "ANY"      => "get_op_data_zval_ptr_undef(EX_OPLINE_EX2(execute_data, opline+1)->op1_type, (opline+1)->op1)",
    "TMP"      => "_get_zval_ptr_tmp((opline+1)->op1.var EXECUTE_DATA_CC)",
    "VAR"      => "_get_zval_ptr_var((opline+1)->op1.var EXECUTE_DATA_CC)",
    "CONST"    => "RT_CONSTANT((opline+1), (opline+1)->op1)",
    "UNUSED"   => "NULL",
...
$op_data_get_zval_ptr_deref = array(
    "ANY"      => "get_op_data_zval_ptr_deref_r(EX_OPLINE_EX2(execute_data, opline+1)->op1_type, (opline+1)->op1)",
    "TMP"      => "_get_zval_ptr_tmp((opline+1)->op1.var EXECUTE_DATA_CC)",
...
$op_data_get_zval_ptr_ptr = array(
    "ANY"      => "get_zval_ptr_ptr(EX_OPLINE_EX2(execute_data, opline+1)->op1_type, (opline+1)->op1, \\1)",
    "TMP"      => "zend_get_bad_ptr()",
...
$op_data_free_op = array(
    "ANY"      => "FREE_OP(EX_OPLINE_EX2(execute_data, opline+1)->op1_type, (opline+1)->op1.var)",
...
function gen_null_handler($f) {
    ...
    if (!$done) {
        ...
        out($f,"\n");
        out($f,"\tSAVE_OPLINE();\n");
        out($f,"\tzend_error_noreturn(E_ERROR, \"Invalid opcode %d/%d/%d.\", EX_OPLINE->opcode, EX_OPLINE->op1_type, EX_OPLINE->op2_type);\n");
                ...
                case "DEFINES":
                    ...
                    switch ($kind) {
                        ...
                        case ZEND_VM_KIND_CALL:
                            ...
                            if ($kind == ZEND_VM_KIND_HYBRID) {
                                out($f,"#define ZEND_VM_DISPATCH(opcode, opline) ZEND_VM_TAIL_CALL(((opcode_handler_t)zend_vm_get_opcode_handler_func(opcode, EX_OPLINE_EX2(execute_data, opline)))(ZEND_OPCODE_HANDLER_ARGS_PASSTHRU));\n");
                            } else {
                                out($f,"#define ZEND_VM_DISPATCH(opcode, opline) ZEND_VM_TAIL_CALL(((opcode_handler_t)zend_vm_get_opcode_handler(opcode, EX_OPLINE_EX2(execute_data, opline))))(ZEND_OPCODE_HANDLER_ARGS_PASSTHRU));\n");
                            }
                            out($f,"\n");
...
function gen_vm($def, $skel) {
    ...
    if (ZEND_VM_KIND == ZEND_VM_KIND_CALL || ZEND_VM_KIND == ZEND_VM_KIND_HYBRID) {
        ...
        if (ZEND_VM_KIND == ZEND_VM_KIND_HYBRID) {
            out($f,"#if (ZEND_VM_KIND == ZEND_VM_KIND_HYBRID)\n");
            out($f, "\tzend_op *wide_op = EX_OPLINE_EX2(execute_data, opline);\n");
