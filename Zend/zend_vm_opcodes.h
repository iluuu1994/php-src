...
ZEND_API ZEND_PURE const char* ZEND_FASTCALL zend_get_opcode_name(uint8_t opcode);
ZEND_API ZEND_PURE uint32_t ZEND_FASTCALL zend_get_opcode_flags(uint8_t opcode);
ZEND_API ZEND_PURE uint8_t zend_get_opcode_id(const char *name, size_t length);
